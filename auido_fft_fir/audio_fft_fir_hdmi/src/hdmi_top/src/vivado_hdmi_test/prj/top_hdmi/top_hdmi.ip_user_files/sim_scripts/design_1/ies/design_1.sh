...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"../../../../top_hdmi.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../top_hdmi.gen/sources_1/bd/design_1/ipshared/f42d/hdl" \
       +incdir+"D:/xinlinx/Vivado/2021.1/data/xilinx_vip/include"
}
