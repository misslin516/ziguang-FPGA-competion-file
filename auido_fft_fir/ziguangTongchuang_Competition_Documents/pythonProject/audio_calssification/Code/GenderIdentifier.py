...
from audio_calssification.Code.FeaturesExtractor import FeaturesExtractor
...
class GenderIdentifier:
    ...
    def __call__(self, females_files_path, males_files_path, females_model_path, males_model_path):
        pass
    def process(self):
        ...
        for file in files:
            ...
            expected_gender = file.split("\\")[0][:-1].replace("TestingData/", "")
